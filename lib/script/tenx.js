...
export class TenXObject extends TenXBaseObject {
     ...
     * 
     * For example, a {@link https://doc.log10x.com/run/regulate|Receiver module} may set the 'printToOutput'
     ...
     * to control whether to serialize the current instance to a target output. 
     * 
     * For example, a {@link https://doc.log10x.com/run/regulate|Receiver module} may set the
