...
The design enables [Edge apps](https://doc.log10x.com/apps/) to report on, regulate, and optimize events at the source while integrating with existing log forwarders (e.g., Fluentd/Bit).
