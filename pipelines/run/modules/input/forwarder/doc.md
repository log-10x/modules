...
The design enables 10x apps — the [Reporter](https://doc.log10x.com/apps/reporter/) (DaemonSet alongside the forwarder) and the [Receiver](https://doc.log10x.com/apps/receiver/) (sidecar, Filter and [Compact](https://doc.log10x.com/apps/receiver/#compact) modes) — to process events at the source while integrating with existing log forwarders (e.g., Fluentd/Bit).
