...
For a real-world example see the [rate receiver](https://doc.log10x.com/run/receive/rate/), which reloads its field-set mute file on disk changes, a GitOps-synced commit applies cluster-wide on the next reload.