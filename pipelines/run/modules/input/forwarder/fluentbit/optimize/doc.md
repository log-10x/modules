...
[Losslessly compact](https://doc.log10x.com/run/transform/#compact) log/trace events collected by Fluent Bit forwarders ***before*** they ship to output (e.g., Splunk, S3). This module is a component of the [Edge Optimizer](https://doc.log10x.com/apps/edge/optimizer/) app.
