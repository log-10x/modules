...
Read events from a Fluent Bit forwarder to transform into typed [TenXObjects](https://doc.log10x.com/api/js/#TenXObject) and filter using local/centralized [reducer](https://doc.log10x.com/run/output/regulate) policies. This module is a component of the [Receiver](https://doc.log10x.com/apps/receiver/) app.
