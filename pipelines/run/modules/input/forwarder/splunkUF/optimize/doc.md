...
[Losslessly compact](https://doc.log10x.com/run/transform/#compact) log/trace events before Splunk UF ships them to indexers. This module is a component of the [Edge Optimizer](https://doc.log10x.com/apps/edge/optimizer/) app.
...
=== ":material-laptop: Nix/OSX"
    ...
    See the [Quickstart](#quickstart) below or the Log10x Edge Optimizer [run instructions](https://doc.log10x.com/apps/edge/optimizer/run/#splunk-uf)
...
!!! note "Template Storage"
    For Splunk to expand compact events, configure template output to store templates in Splunk. See the [10x for Splunk](https://doc.log10x.com/apps/edge/optimizer/splunk/) documentation.
