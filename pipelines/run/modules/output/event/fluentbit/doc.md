...
- **[Storage Streamer](https://doc.log10x.com/apps/cloud/streamer/#query)**: Ships query results from cloud storage (e.g., S3) to log analyzers and time-series databases.
