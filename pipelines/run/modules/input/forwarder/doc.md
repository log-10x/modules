...
The design enables 10x apps — the [Reporter](https://doc.log10x.com/apps/reporter/) (DaemonSet alongside the forwarder) and the [Regulator](https://doc.log10x.com/apps/regulator/) (sidecar, Filter and [Compact](https://doc.log10x.com/apps/regulator/#compact) modes) — to process events at the source while integrating with existing log forwarders (e.g., Fluentd/Bit).
