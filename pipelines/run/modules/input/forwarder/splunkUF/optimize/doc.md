...
[Losslessly compact](https://doc.log10x.com/run/transform/#compact) log/trace events before Splunk UF ships them to indexers. This module is a component of the [Receiver with optimization](https://doc.log10x.com/apps/receiver/) app.
...
=== ":material-laptop: Nix/OSX"
    ...
    See the [Quickstart](#quickstart) below or the Log10x Receiver with optimization [run instructions](https://doc.log10x.com/apps/receiver/run/#splunk-uf)
...
!!! note "Template Storage"
    For Splunk to expand compact events, configure template output to store templates in Splunk. See the [10x for Splunk](https://doc.log10x.com/apps/receiver/splunk/) documentation.
