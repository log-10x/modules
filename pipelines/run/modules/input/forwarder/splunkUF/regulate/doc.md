...
Read events from application logs to transform into typed [TenXObjects](https://doc.log10x.com/api/js/#TenXObject) and filter using local/centralized [regulator](https://doc.log10x.com/run/output/regulate) policies, before Splunk UF ships them to indexers. This module is a component of the [Edge Regulator](https://doc.log10x.com/apps/edge/regulator/) app.
...
=== ":material-laptop: Nix/OSX"
    ...
    See the [Quickstart](#quickstart) below or the Log10x Edge Regulator [run instructions](https://doc.log10x.com/apps/edge/regulator/run/#splunk-uf)
