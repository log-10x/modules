...
Read events from OpenTelemetry Collector and filter them using local/centralized [reducer](https://doc.log10x.com/run/output/regulate) policy. This module is a component of the [Reducer](https://doc.log10x.com/apps/reducer/) app.
...
graph LR
    ...
    C --> D["<div style='font-size: 14px;'>⚡ 10x Reducer</div><div style='font-size: 10px;'>filter policy</div>"]
...
=== ":material-laptop: Nix/Win/OSX"
    ...
    See the Log10x Reducer OTel Collector [run instructions](https://doc.log10x.com/apps/reducer/run/#otel-collector)

=== ":material-kubernetes: k8s"

    Deploy to k8s via [Helm](https://helm.sh/)

    See the Log10x Reducer OTel Collector [deployment instructions](https://doc.log10x.com/apps/reducer/deploy/#otel-collector)
