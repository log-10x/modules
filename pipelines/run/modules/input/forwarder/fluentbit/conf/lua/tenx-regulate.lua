-- 10x 'regulate' lua config --

-- this script loaded by tenx-regulate.conf to configure the 10x sub-process and event processing
...
-- Record processing
	...
	-- In the 10x 'regulate' configuration, events are handled and possibly dropped by
...
-- Launching 10x
	...
	tenx_run_args = "@run/input/forwarder/fluentbit/regulate/config.yaml __SAVE_APPS_REDUCER__"
