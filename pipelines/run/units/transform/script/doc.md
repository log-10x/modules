...
| [Regulator](https://doc.log10x.com/run/output/regulate)        | Filter 'noisy' telemetry via per-node budget sampling or a declarative field-set mute file to prevent over-billing.                      | [Rate](https://github.com/log-10x/modules/blob/main/pipelines/run/modules/regulate/rate/rate-object-global.js)                         |
