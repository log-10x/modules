...
For an example configuration, see the [OpenTelemetry Collector forwarder output](https://github.com/log-10x/modules/blob/main/pipelines/run/modules/input/forwarder/otel-collector/output/stream.yaml).
