...
[Pulling](https://doc.log10x.com/compile/pull/github/) prior symbol files and [pushing](https://doc.log10x.com/compile/push/) new ones enables incremental builds for large codebases.
