...
For a real-world example see the [rate reducer](https://doc.log10x.com/run/regulate/rate/), which reloads its field-set mute file on disk changes — a GitOps-synced commit applies cluster-wide on the next reload.