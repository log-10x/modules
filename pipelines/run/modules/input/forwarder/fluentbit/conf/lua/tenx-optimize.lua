...
-- Record processing
	...
	-- In the 10x 'optimize' configuration, events are handled and possibly dropped by
...
-- Launching 10x
	...
	-- Define 10x arguments for running in 'optimize' mode
	tenx_run_args = "@run/input/forwarder/fluentbit/optimize/config.yaml @apps/edge/optimizer"
