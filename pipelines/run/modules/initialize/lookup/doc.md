...
The [rate receiver](https://doc.log10x.com/run/receive/rate/) consumes a field-set keyed mute file pulled from GitHub, letting operators declaratively cap noisy patterns with diff-reviewed, self-expiring entries.