...
This [module](https://doc.log10x.com/engine/module/) configures a Filebeat [script processor](https://www.elastic.co/guide/en/beats/filebeat/current/processor-script.html). The script processor launches a 10x [sidecar process](https://doc.log10x.com/engine/launcher/sidecar) and pipes collected events to aggregate and publish to [time-series](https://doc.log10x.com/run/output/metric/) outputs.
