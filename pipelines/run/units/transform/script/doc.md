...
| [Regulator](https://doc.log10x.com/run/output/regulate)        | Filter 'noisy' telemetry based on node-specific and environment-wide policies to prevent over-billing.                                         | [Policy](https://github.com/log-10x/modules/blob/main/pipelines/run/modules/regulate/policy/policy-regulator-object.js)               |
